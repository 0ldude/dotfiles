...
local osc_styles = {
    bigButtons = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs50\\fnmpv-osd-symbols}",
    smallButtonsL = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs19\\fnmpv-osd-symbols}",
    smallButtonsLlabel = "{\\fscx105\\fscy105\\fn" .. mp.get_property("options/osd-font") .. "}",
    smallButtonsR = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs30\\fnmpv-osd-symbols}",
    topButtons = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs12\\fnmpv-osd-symbols}",

    elementDown = "{\\1c&H1D2021}",
    timecodes = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs20}",
    vidtitle = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs12\\q2}",
    box = "{\\rDefault\\blur0\\bord1\\1c&HF9F5D7\\3c&H1D2021}",

    topButtonsBar = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs18\\fnmpv-osd-symbols}",
    smallButtonsBar = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs28\\fnmpv-osd-symbols}",
    timecodesBar = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs27}",
    timePosBar = "{\\blur0\\bord".. user_opts.tooltipborder .."\\1c&H1D2021\\3c&HF9F5D7\\fs30}",
    vidtitleBar = "{\\blur0\\bord0\\1c&H1D2021\\3c&H1D2021\\fs18\\q2}",

    wcButtons = "{\\1c&H1D2021\\fs24\\fnmpv-osd-symbols}",
    wcTitle = "{\\1c&H1D2021\\fs24\\q2}",
    wcBar = "{\\1c&HF9F5D7}",
}
...
layouts["slimbox"] = function ()
    ...
    local styles = {
        box = "{\\rDefault\\blur0\\bord1\\1c&HF9F5D7\\3c&H1D2021}",
        timecodes = "{\\1c&H1D2021\\3c&HF9F5D7\\fs20\\bord2\\blur1}",
        tooltip = "{\\1c&H1D2021\\3c&HF9F5D7\\fs12\\bord1\\blur0.5}",
    }
